...
export const saelSlides: SlideDef[] = [
  ...
  {
    id: 'sl1b', theme: 'light', title: 'Who we are',
    html: `
    <div class="slidebody">
  ...
  {
    id: 'sl2b', theme: 'light', title: 'Where it breaks at scale',
    html: `
    <div class="fullslide"><img src="assets/product/sael/breaks-at-scale.jpg" alt="Where frontline workforce systems break at scale"/></div>`,
  },
  {
  ...
  },
  {
    ...
    html: `
    <div class="fullslide"><img src="assets/product/sael/lifecycle-11-modules.jpg" alt="The complete contractual and frontline workforce lifecycle - eleven modules"/></div>`,
  },
  {
